...
exports.getOAuthAccessToken = function(params) {

    ng.utils.checkRequiredOptions(params, [
        'oauth_token',
        'oauth_token_secret',
        'oauth_verifier',
        'next'
    ...
    getAuth().getOAuthAccessToken(params.oauth_token, params.oauth_token_secret, params.oauth_verifier, params.next)
}
